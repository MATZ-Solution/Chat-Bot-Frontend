  ...
  useEffect(() => {
    const initializeChat = () => {
      const welcomeMessage = {
        role: 'model',
        parts: 'Hi, I am David, personalized assistant of Info Senior Care. Here to provide the best assistance! Ask me anything about our company, industry, or finding nursing cares. How can I help you?',
